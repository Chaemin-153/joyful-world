...
const Footer = () => {
  return (
    <footer className="w-full border-t bg-gray-50">
      <div className="mx-auto max-w-6xl px-4 py-6 text-sm text-brown flex justify-between">
        <Link to="/" className="font-bold text-lg">
          <img src="/logo_nobackground.png" alt="brand_logo" className="w-36" />
        </Link>
        ...
        <div className="flex flex-col gap-2">
          {/* <div>joyful_honeyjam@naver.com</div>
          <div>INSTAGRAM</div> */}
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 text-sm text-brown flex flex-col gap-2">
        <span>
          잼있는 세상 | 사업자등록번호 721-34-01365 | 통신판매업신고번호 제
          2024-서울광진-1525 | 대표 이지은
        </span>
        <span>
